---
title: "RNAseq compendium filtering validation: PAO1"
...
## full
rnaseq_comp_full <- read.csv('compendia/TPM_pao1_cdna_k15.csv', stringsAsFactors = F, row.names = 2)
rownames(rnaseq_comp_full) <- make.unique(sapply(rownames(rnaseq_comp_full), function(x) name_to_PAO1(x)))
rnaseq_comp_counts_full <- read.csv('compendia/num_reads_pao1_cdna_k15.csv', stringsAsFactors = F, row.names = 2)
rownames(rnaseq_comp_counts_full) <- make.unique(sapply(rownames(rnaseq_comp_counts_full), function(x) name_to_PAO1(x)))

# filtered at 0.2
rnaseq_comp_p2 <- read.csv('filtered_compendia/jor_pao1_aligned_rnaseq_compendium_filtered_tpm_zp2.csv', stringsAsFactors = F, row.names = 1)
rownames(rnaseq_comp_p2) <- make.unique(sapply(rownames(rnaseq_comp_p2), function(x) name_to_PAO1(x)))

rnaseq_comp_counts_p2 <- read.csv('filtered_compendia/jor_pao1_aligned_rnaseq_compendium_filtered_counts_zp2.csv', stringsAsFactors = F, row.names = 1)
rownames(rnaseq_comp_counts_p2) <- make.unique(sapply(rownames(rnaseq_comp_counts_p2), function(x) name_to_PAO1(x)))

rnaseq_comp_counts_p2_QC_out_file <- read.csv('../2021_06_24_pa-seq-compendia/pa-seq-compendia/qc_filtering/filtered_compendia/pao1_aligned_rnaseq_compendium_zp2_MRnorm.csv', stringsAsFactors = F, row.names = 1)


# filtered at 0.7
rnaseq_comp_p7 <- read.csv('filtered_compendia/jor_pao1_aligned_rnaseq_compendium_filtered_tpm_zp7.csv', stringsAsFactors = F, row.names = 1)
rownames(rnaseq_comp_p7) <- make.unique(sapply(rownames(rnaseq_comp_p7), function(x) name_to_PAO1(x)))
rnaseq_comp_counts_p7 <- read.csv('filtered_compendia/jor_pao1_aligned_rnaseq_compendium_filtered_counts_zp7.csv', stringsAsFactors = F, row.names = 1)
rownames(rnaseq_comp_counts_p7) <- make.unique(sapply(rownames(rnaseq_comp_counts_p7), function(x) name_to_PAO1(x)))
...
write.csv(regs_stats,paste0(c,'_regs_corr_stats_pao1.csv'))
})
...
write.csv(regsp_stats,paste0(c,'_reg_precise_corr_stats_pao1.csv'))
})
...
write.csv(ops_stats,paste0(c,'_operons_corr_stats_pao1.csv'))
})
```
...
ggsave('pearson_dists_comps_filter_norm_prism_plot_PAO1.png', width=6, height=8)
ggsave('pearson_dists_comps_filter_norm_prism_plot_PAO1.svg', width=6, height=8)
```
...
ggsave('pearson_dists_comps_filter_norm_prism_plot_operons_PAO1.png', width=6, height=8)
ggsave('pearson_dists_comps_filter_norm_prism_plot_operons_PAO1_size.png', width=4, height=9)
```
...
ggsave('pearson_dists_comps_filter_norm_prism_plot_regp_PAO1.png', width=6, height=8)
ggsave('pearson_dists_comps_filter_norm_prism_plot_regp_PAO1_size.png', width=4, height=9)
```
...
g_reg_break <- ggplot(plot_temp_names) +
  ...
  theme_bw() + theme_prism(base_fontface = 'plain', base_line_size = 0.5)
g_reg_break
ggsave('pearson_dists_comps_filter_norm_prism_plot_regs_breakout_pho_vre_algU_lexA_psrA_nozs_PAO1.png', width=8, height=3)
```
...
g_reg_break <- ggplot(plot_temp_names) +
  ...
  theme_bw() + theme_prism(base_fontface = 'plain', base_line_size = 0.5)
g_reg_break
ggsave('pearson_dists_comps_filter_norm_prism_plot_regs_breakout_pho_vre_gbdR_sigX_lexA_nozs_PAO1.png', width=8, height=3)
```
...
g_reg_break <- ggplot(plot_temp_names) +
  ...
  theme_bw() + theme_prism(base_fontface = 'plain', base_line_size = 0.5)
g_reg_break
ggsave('pearson_dists_comps_filter_norm_prism_plot_regs_breakout_pho_vre_gbdR_sigX_algU_lexA_nozs_PAO1.png', width=9, height=3)
```
...
g_reg_break <- ggplot(plot_temp_names) +
  ...
  theme_bw() + theme_prism(base_fontface = 'plain', base_line_size = 0.5)
g_reg_break
ggsave('pearson_dists_comps_filter_norm_prism_plot_regs_breakout_pho_vre_algU_lexA_nozs_PAO1.png', width=9, height=3)
```
