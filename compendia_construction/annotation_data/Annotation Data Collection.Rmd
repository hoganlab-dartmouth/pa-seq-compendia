---
title: "Annotation Data Collection (Clean)"
...
PA_Summaries <- read.delim("PA_Summaries.txt", header = FALSE, sep = "\t", dec = ".")
...
Ultimately, the data in this spreadsheet was edited so that each cell has only the appropriate values (i.e., removed duplicate values separated by columns). The edited spreadsheet is present in the supplementary files for the publication associated with this work.  
